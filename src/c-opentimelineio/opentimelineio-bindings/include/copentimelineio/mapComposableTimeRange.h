...
typedef struct MapComposableTimeRangeIterator MapComposableTimeRangeIterator;
...
OTIO_API void 
MapComposableTimeRange_swap(MapComposableTimeRange* self, MapComposableTimeRange* other);

OTIO_API int 
MapComposableTimeRange_erase_key(MapComposableTimeRange* self, Composable* key);
...
OTIO_API bool  
MapComposableTimeRangeIterator_equal(
    MapComposableTimeRangeIterator* lhs,
    MapComposableTimeRangeIterator* rhs);

OTIO_API bool
MapComposableTimeRangeIterator_not_equal(
    MapComposableTimeRangeIterator* lhs,
    MapComposableTimeRangeIterator* rhs);

OTIO_API void 
MapComposableTimeRangeIterator_advance(MapComposableTimeRangeIterator* iter, int dist);

OTIO_API MapComposableTimeRangeIterator* 
MapComposableTimeRange_insert(MapComposableTimeRange* self, Composable* key, TimeRange* anyObj);

OTIO_API MapComposableTimeRangeIterator* 
MapComposableTimeRange_erase(MapComposableTimeRange* self, MapComposableTimeRangeIterator* pos);

OTIO_API MapComposableTimeRangeIterator* 
MapComposableTimeRange_erase_range(
