...
OTIO_API char* MissingReference_name(MissingReference* self)
{
...
OTIO_API char* MissingReference_to_json_string(
...
OTIO_API char* MissingReference_schema_name(MissingReference* self)
{
