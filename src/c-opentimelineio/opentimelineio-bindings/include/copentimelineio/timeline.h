...
OTIO_API Timeline* Timeline_clone(
                        Timeline* self, 
...
OTIO_API void           Timeline_set_global_start_time(Timeline* self, RationalTime* global_start_time);
OTIO_API RationalTime*  Timeline_duration(Timeline* self, OTIOErrorStatus* error_status);

OTIO_API TimeRange*     Timeline_range_of_child(Timeline* self, Composable* child, OTIOErrorStatus* error_status);
