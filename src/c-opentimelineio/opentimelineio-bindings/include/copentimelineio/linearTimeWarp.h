...
extern "C"
{
    ...
    char* LinearTimeWarp_effect_name(LinearTimeWarp* self);
    void        LinearTimeWarp_set_effect_name(
               LinearTimeWarp* self, const char* effect_name);
    char* LinearTimeWarp_name(LinearTimeWarp* self);
    ...
    bool          LinearTimeWarp_to_json_file(
                 ...
                 int              indent);
    char* LinearTimeWarp_to_json_string(
    ...
    char* LinearTimeWarp_schema_name(LinearTimeWarp* self);
