...
OTIO_API TimeRange*    Track_trimmed_range_in_parent(Track* self, OTIOErrorStatus* error_status);
...
OTIO_API bool Track_set_children(Track* self, ComposableVector* children, OTIOErrorStatus* error_status);
...
OTIO_API bool Track_set_child(
                    ...
                    Composable*      child,
                    OTIOErrorStatus* error_status);
OTIO_API bool Track_remove_child(Track* self, int index, OTIOErrorStatus* error_status);
OTIO_API bool Track_append_child(Track* self, Composable* child, OTIOErrorStatus* error_status);

OTIO_API TimeRange* Track_range_of_child(Track* self, Composable* child, OTIOErrorStatus* error_status);
OTIO_API TimeRange* Track_trimmed_range_of_child(Track* self, Composable* child, OTIOErrorStatus* error_status);
...
OTIO_API TimeRange* Track_range_of_child_at_index(Track* self, int index, OTIOErrorStatus* error_status);
OTIO_API TimeRange* Track_trimmed_range_of_child_at_index(Track* self, int index, OTIOErrorStatus* error_status);
OTIO_API OptionalPairRationalTime* Track_handles_of_child(Track* self, Composable* child, OTIOErrorStatus* error_status);
OTIO_API MapComposableTimeRange* Track_range_of_all_children(Track* self, OTIOErrorStatus* error_status);
