...
OTIO_API char* LinearTimeWarp_effect_name(LinearTimeWarp* self)
{
...
OTIO_API char* LinearTimeWarp_name(LinearTimeWarp* self)
{
...
OTIO_API char* LinearTimeWarp_to_json_string(
...
OTIO_API char* LinearTimeWarp_schema_name(LinearTimeWarp* self)
{
