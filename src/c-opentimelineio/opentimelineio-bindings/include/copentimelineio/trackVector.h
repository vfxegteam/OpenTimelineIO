...
OTIO_API TrackVectorIterator* TrackVector_insert(TrackVector* self, TrackVectorIterator* pos, Track* val);
OTIO_API TrackVectorIterator* TrackVector_erase(TrackVector* self, TrackVectorIterator* pos);
...
OTIO_API bool TrackVectorIterator_equal(TrackVectorIterator* lhs, TrackVectorIterator* rhs);
OTIO_API bool TrackVectorIterator_not_equal(TrackVectorIterator* lhs, TrackVectorIterator* rhs);
