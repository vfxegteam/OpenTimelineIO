...
OTIO_API char* TimeEffect_effect_name(TimeEffect* self)
{
...
OTIO_API char* TimeEffect_name(TimeEffect* self)
{
...
OTIO_API char* TimeEffect_to_json_string(
...
OTIO_API char* TimeEffect_schema_name(TimeEffect* self)
{
