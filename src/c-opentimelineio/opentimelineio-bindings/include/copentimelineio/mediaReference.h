...
OTIO_API char* MediaReference_name(MediaReference* self);
...
OTIO_API bool          MediaReference_to_json_file(
             ...
             int              indent);
OTIO_API char* MediaReference_to_json_string(
...
OTIO_API char* MediaReference_schema_name(MediaReference* self);
