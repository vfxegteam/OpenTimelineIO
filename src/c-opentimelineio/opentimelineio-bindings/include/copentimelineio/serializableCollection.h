...
OTIO_API char* SerializableCollection_name(SerializableCollection* self);
...
OTIO_API bool SerializableCollection_to_json_file(
    ...
    OTIOErrorStatus*        error_status,
    int                     indent);
OTIO_API char* SerializableCollection_to_json_string(
    SerializableCollection* self,
    OTIOErrorStatus*        error_status,
    int                     indent);
...
OTIO_API char* SerializableCollection_schema_name(SerializableCollection* self);
